...
namespace ASP.NET_Core_Webapp.Configurations
{
    ...
    public static class TestAuthenticationExtensions
    {
        ...
        {
            return builder.AddScheme<TestAuthenticationOptions, TestAuthenticationHandler>("Bearer", "Test Auth", configureOptions);
        }
    }
